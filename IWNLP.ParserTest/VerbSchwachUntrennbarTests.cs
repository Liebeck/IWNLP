        ...
        public void iahen()
        {
            ...
            List<VerbConjugation> expectedWords = new List<VerbConjugation>()
            {
                 new VerbConjugation()
                 {
                    ...
                    PräsensAktivIndikativ_Singular2Person = new List<string>(){"iahst", "iahest"},
                    PräsensAktivIndikativ_Singular3Person = new List<string>(){"iaht", "iahet"},
                    PräsensAktivIndikativ_Plural1Person = new List<string>(){"iahen"},
                    PräsensAktivIndikativ_Plural2Person = new List<string>(){"iaht", "iahet"},
                    PräsensAktivIndikativ_Plural3Person = new List<string>(){"iahen"},
                    PräteritumAktivIndikativ_Singular1Person = new List<string>(){"iahte", "iahete"},
                    PräteritumAktivIndikativ_Singular2Person  = new List<string>(){"iahtest", "iahetest"},
                    PräteritumAktivIndikativ_Singular3Person  = new List<string>(){"iahte", "iahete"},
                    PräteritumAktivIndikativ_Plural1Person  = new List<string>(){"iahten", "iaheten"},
                    PräteritumAktivIndikativ_Plural2Person =  new List<string>(){"iahtet", "iahetet"},
                    PräteritumAktivIndikativ_Plural3Person  = new List<string>(){"iahten", "iaheten"},
                    ...
                    PräteritumAktivKonjunktiv_Singular1Person = new List<string>(){"iahte", "iahete"},
                    PräteritumAktivKonjunktiv_Singular2Person = new List<string>(){"iahtest", "iahetest"},
                    PräteritumAktivKonjunktiv_Singular3Person = new List<string>(){"iahte", "iahete"},
                    PräteritumAktivKonjunktiv_Plural1Person = new List<string>(){"iahten", "iaheten"},
                    PräteritumAktivKonjunktiv_Plural2Person = new List<string>(){"iahtet", "iahetet"},
                    PräteritumAktivKonjunktiv_Plural3Person = new List<string>(){"iahten", "iaheten"},
                    PartizipII = "geiaht",
                    PartizipIIAlternativ = "iaht",
                    PartizipIIVeraltet = "geiahet"
                 }
            };
            if(!AppSettingsWrapper.SuppressDumps){XMLSerializer.Serialize<List<Models.Entry>>(expectedWords.Cast<Models.Entry>().ToList(), System.IO.Path.Combine(AppSettingsWrapper.UnitTestDumpDirectory, "verb_1.txt"));}
            if(!AppSettingsWrapper.SuppressDumps){XMLSerializer.Serialize<List<Models.Entry>>(words.Cast<Models.Entry>().ToList(), System.IO.Path.Combine(AppSettingsWrapper.UnitTestDumpDirectory, "verb_2.txt"));}
        ...
        public void bechern()
        {
            ...
            List<VerbConjugation> expectedWords = new List<VerbConjugation>()
            {
                 new VerbConjugation()
                 {
                    ...
                    PräsensAktivKonjunktiv_Singular2Person = new List<string>(){"becherst"},
                    ...
                    PräsensAktivKonjunktiv_Plural2Person = new List<string>(){"bechert"},
        ...
        public void schwänzeln()
        {
            ...
            List<VerbConjugation> expectedWords = new List<VerbConjugation>()
            {
                 new VerbConjugation()
                 {
                    ...
                    PräsensAktivKonjunktiv_Singular2Person = new List<string>(){"schwänzelst","schwänzlest"},
                    ...
                    PräsensAktivKonjunktiv_Plural2Person = new List<string>(){"schwänzelt","schwänzlet"},
        ...
        public void lästern()
        {
            ...
            List<VerbConjugation> expectedWords = new List<VerbConjugation>()
            {
                 new VerbConjugation()
                 {
                    ...
                    PräsensAktivKonjunktiv_Singular2Person = new List<string>(){"lästerst"},
                    ...
                    PräsensAktivKonjunktiv_Plural2Person = new List<string>(){"lästert"},
        ...
        public void verweigern()
        {
            ...
            List<VerbConjugation> expectedWords = new List<VerbConjugation>()
            {
                 new VerbConjugation()
                 {
                    ...
                    PräsensAktivKonjunktiv_Singular2Person = new List<string>(){"verweigerst", "verweigerest","verweigrest"},
                    PräsensAktivKonjunktiv_Singular3Person = new List<string>(){"verweigere","verweigre"},
                    PräsensAktivKonjunktiv_Plural1Person = new List<string>(){"verweigern", "verweigren", "verweigeren"},
                    PräsensAktivKonjunktiv_Plural2Person = new List<string>(){"verweigert", "verweigret","verweigeret"},
                    PräsensAktivKonjunktiv_Plural3Person = new List<string>(){"verweigern", "verweigren", "verweigeren"},
