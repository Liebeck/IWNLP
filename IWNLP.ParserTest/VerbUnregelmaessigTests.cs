        ...
        public void stehen()
        {
            ...
            List<VerbConjugation> expectedWords = new List<VerbConjugation>()
            {
                 new VerbConjugation()
                 {
                    ...
                    PräteritumAktivIndikativ_Singular2Person  = new List<string>(){"standst"},
        ...
        public void antun()
        {
            ...
            List<VerbConjugation> expectedWords = new List<VerbConjugation>()
            {
                 new VerbConjugation()
                 {
                    ...
                    PräteritumAktivIndikativ_Singular2Person  = new List<string>(){"tatst an"},
                    PräteritumAktivIndikativ_Singular2Person_Nebensatzkonjugation  = new List<string>(){"antatst"},
        ...
        public void tun()
        {
            ...
            List<VerbConjugation> expectedWords = new List<VerbConjugation>()
            {
                 new VerbConjugation()
                 {
                    ...
                    PräteritumAktivIndikativ_Singular2Person  = new List<string>(){"tatst"},
