        ...
        public void abwaschen()
        {
            ...
            List<VerbConjugation> expectedWords = new List<VerbConjugation>()
            {
                 new VerbConjugation()
                 {
                    ...
                    PräteritumAktivIndikativ_Singular2Person  = new List<string>(){"wuschst ab", "wuscht ab"},
                    PräteritumAktivIndikativ_Singular2Person_Nebensatzkonjugation  = new List<string>(){"abwuschst", "abwuscht"},
        ...
        public void bersten()
        {
            ...
            List<VerbConjugation> expectedWords = new List<VerbConjugation>()
            {
                 new VerbConjugation()
                 {
                    ...
                    PräteritumAktivKonjunktiv_Singular1Person = new List<string>(){"bärste", "börste"},
                    PräteritumAktivKonjunktiv_Singular2Person = new List<string>(){"bärstest", "börstest"},
                    PräteritumAktivKonjunktiv_Singular3Person = new List<string>(){"bärste", "börste"},
                    PräteritumAktivKonjunktiv_Plural1Person = new List<string>(){"bärsten", "börsten"},
                    PräteritumAktivKonjunktiv_Plural2Person = new List<string>(){"bärstet", "börstet"},
                    PräteritumAktivKonjunktiv_Plural3Person = new List<string>(){"bärsten", "börsten"},
        ...
        public void dreschen()
        {
            ...
            List<VerbConjugation> expectedWords = new List<VerbConjugation>()
            {
                 new VerbConjugation()
                 {
                    ...
                    PräteritumAktivIndikativ_Singular2Person  = new List<string>(){"droschst", "droscht"},
        ...
        public void anschreien()
        {
            ...
            List<VerbConjugation> expectedWords = new List<VerbConjugation>()
            {
                 new VerbConjugation()
                 {
                    ...
                    PräteritumAktivKonjunktiv_Singular2Person = new List<string>(){"schriest an"},
                    PräteritumAktivKonjunktiv_Singular2Person_Nebensatzkonjugation = new List<string>(){"anschriest"},
                    ...
                    PräteritumAktivKonjunktiv_Plural2Person = new List<string>(){"schriet an"},
                    PräteritumAktivKonjunktiv_Plural2Person_Nebensatzkonjugation = new List<string>(){"anschriet"},
        ...
        public void reinwaschen()
        {
            ...
            List<VerbConjugation> expectedWords = new List<VerbConjugation>()
            {
                 new VerbConjugation()
                 {
                    ...
                    PräteritumAktivIndikativ_Singular2Person  = new List<string>(){"wuschst rein", "wuscht rein"},
                    PräteritumAktivIndikativ_Singular2Person_Nebensatzkonjugation  = new List<string>(){"reinwuschst", "reinwuscht"},
